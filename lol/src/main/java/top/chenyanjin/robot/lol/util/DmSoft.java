...
import com.cjoop.dm.DMException;
import com.cjoop.dm.ProcessInputStream;
import com.cjoop.dm.Utils;
...
public class DmSoft {
	...
	public static void loadDmInfo() throws Exception {
		...
		if(!checkDmDll()){
			...
			extractResourceToFolder(com.cjoop.dm.DmSoft.class.getClassLoader(),tempFolder);
			regDmDll(tempFolder);
		};
	}
